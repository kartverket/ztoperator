...
func (in *AuthPolicySpec) DeepCopyInto(out *AuthPolicySpec) {
	*out = *in
	if in.Rules != nil {
		...
		*out = make(RequestAuthList, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in RequestAuthList) DeepCopyInto(out *RequestAuthList) {
	{
		in := &in
		*out = make(RequestAuthList, len(*in))
		for i := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RequestAuthList.
func (in RequestAuthList) DeepCopy() RequestAuthList {
	if in == nil {
		return nil
	}
	out := new(RequestAuthList)
	in.DeepCopyInto(out)
	return *out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in RequestAuthRules) DeepCopyInto(out *RequestAuthRules) {
	{
		in := &in
		*out = make(RequestAuthRules, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RequestAuthRules.
func (in RequestAuthRules) DeepCopy() RequestAuthRules {
	if in == nil {
		return nil
	}
	out := new(RequestAuthRules)
	in.DeepCopyInto(out)
	return *out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in RequestMatcherList) DeepCopyInto(out *RequestMatcherList) {
	{
		in := &in
		*out = make(RequestMatcherList, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RequestMatcherList.
func (in RequestMatcherList) DeepCopy() RequestMatcherList {
	if in == nil {
		return nil
	}
	out := new(RequestMatcherList)
	in.DeepCopyInto(out)
	return *out
}
