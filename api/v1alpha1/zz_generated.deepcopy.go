...
func (in *AllowedAudiences) DeepCopyInto(out *AllowedAudiences) {
	*out = *in
	if in.Value != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AllowedAudiences.
func (in *AllowedAudiences) DeepCopy() *AllowedAudiences {
	if in == nil {
		return nil
	}
	out := new(AllowedAudiences)
	in.DeepCopyInto(out)
	return out
}
...
func (in *AuthPolicySpec) DeepCopyInto(out *AuthPolicySpec) {
	*out = *in
	...
	if in.AllowedAudiences != nil {
		...
		*out = make([]AllowedAudiences, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
